# /dev/CMSSW_7_4_0/50nsHLT/V215 (CMSSW_7_4_3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_7_4_0/50nsHLT/V215')
)
...
process.datasets = cms.PSet( 
  ...
  ElectronStream = cms.vstring( 'HLT_Ele27_eta2p1_WPLoose_Gsf_v1' ),
  ...
  LookAreaPD = ( cms.vstring( 'HLT_AK4CaloJet100_v2',
    ...
    'HLT_Mu15_PFHT300_v2')+cms.vstring( 'HLT_Mu16_TkMu0_dEta18_Onia_v2',
  ...
  OnlineMonitor = ( cms.vstring( 'HLT_AK4CaloJet100_v2',
    ...
    'HLT_Mu15_IsoVVVL_BTagCSV0p72_PFHT400_v2',
    'HLT_Mu15_IsoVVVL_PFHT350_PFMET70_v1',
    'HLT_Mu15_IsoVVVL_PFHT600_v2')+cms.vstring( 'HLT_Mu15_PFHT300_v2',
    'HLT_Mu16_TkMu0_dEta18_Onia_v2',
    'HLT_Mu16_TkMu0_dEta18_Phi_v2',
    'HLT_Mu16_eta2p1_CaloMET30_v2',
    'HLT_Mu17_Mu8_DZ_v1',
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_HIL2Mu3_v2, process.HLT_HIL2DoubleMu0_v2, process.HLT_HIL3Mu3_v2, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
#        'file:/tmp/hbrun/theMCfile.root',
	'/store/relval/CMSSW_7_4_6/RelValZMM_13/GEN-SIM-DIGI-RAW-HLTDEBUG/PU25ns_MCRUN2_74_V9-v2/00000/0496D87C-EC19-E511-9DFA-0025905A48B2.root'
    ),
...
process.runL2seed = cms.EDAnalyzer('HLTmuonRecoAnalyzer',
                                   ...
                                   L3muonsCollection = cms.InputTag("hltHIL3MuonCandidates","","HLTfancy"),
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = 'MCRUN2_740TV1')
...
_customInfo['inputFile' ]=  ['file:/tmp/hbrun/theMCfile.root']
